...
//!
//! Design principles:
//! - Neutral gray tones from Tailwind's Zinc palette
...
// =============================================================================
// Neutral gray tones with good contrast
...
pub const GRAY_50: Color32 = ZINC_950;
pub const GRAY_100: Color32 = ZINC_900;
pub const GRAY_150: Color32 = ZINC_800;
pub const GRAY_200: Color32 = ZINC_700;
pub const GRAY_250: Color32 = ZINC_600;
pub const GRAY_300: Color32 = ZINC_600;
pub const GRAY_350: Color32 = ZINC_500;
pub const GRAY_400: Color32 = ZINC_500;
pub const GRAY_500: Color32 = ZINC_400;
pub const GRAY_600: Color32 = ZINC_300;
pub const GRAY_700: Color32 = ZINC_200;
pub const GRAY_800: Color32 = ZINC_100;
pub const GRAY_900: Color32 = ZINC_50;
pub const GRAY_1000: Color32 = Color32::from_rgb(255, 255, 255);

pub const GRAY_325: Color32 = ZINC_500;
pub const GRAY_550: Color32 = ZINC_400;
pub const GRAY_775: Color32 = ZINC_100;
...
pub const TOP_BAR_BG: Color32 = ZINC_900;
/// Tab bar background
pub const TAB_BAR_BG: Color32 = ZINC_800;
/// Bottom bar / footer background
pub const BOTTOM_BAR_BG: Color32 = ZINC_900;
/// Elevated surface (cards, dialogs, popups)
pub const SURFACE_ELEVATED: Color32 = ZINC_700;
/// Text edit / input field background
pub const TEXT_EDIT_BG: Color32 = ZINC_700;
/// Hover state background
pub const HOVER_BG: Color32 = ZINC_600;
...
/// Default body text
pub const TEXT_DEFAULT: Color32 = ZINC_200;
/// Secondary/muted text
pub const TEXT_SUBDUED: Color32 = ZINC_400;
/// Disabled/non-interactive text
pub const TEXT_DISABLED: Color32 = ZINC_500;
...
pub const WIDGET_INACTIVE_BG: Color32 = ZINC_700;
/// Widget hovered background
pub const WIDGET_HOVERED_BG: Color32 = ZINC_600;
/// Widget active/pressed background
pub const WIDGET_ACTIVE_BG: Color32 = ZINC_400;
/// Non-interactive widget background
pub const WIDGET_NONINTERACTIVE_BG: Color32 = ZINC_800;
/// Border color (use sparingly - prefer no borders)
pub const BORDER_COLOR: Color32 = ZINC_600;
/// Secondary border color
pub const BORDER_SECONDARY: Color32 = ZINC_500;
...
pub const TABLE_ROW_EVEN: Color32 = ZINC_900;
/// Zebra stripe: odd row alternating background (between ZINC_900 and ZINC_800)
pub const TABLE_ROW_ODD: Color32 = Color32::from_rgb(30, 30, 33);
/// Table header background
pub const TABLE_HEADER_BG: Color32 = ZINC_800;
/// Table header text color
pub const TABLE_HEADER_TEXT: Color32 = ZINC_300;
/// Table cell text color
pub const TABLE_CELL_TEXT: Color32 = ZINC_200;
/// Index column text color (subdued)
pub const TABLE_INDEX_TEXT: Color32 = ZINC_400;
...
pub const PANE_HEADER_BACKGROUND_COLOR: Color32 = ZINC_800;
/// Pane header foreground/text color
pub const PANE_HEADER_FOREGROUND_COLOR: Color32 = ZINC_300;
...
// Background colors
pub const BACKGROUND_COLOR: Color32 = ZINC_800;
pub const HEADER_BACKGROUND: Color32 = ZINC_800;
pub const DARK_BACKGROUND: Color32 = ZINC_900;
...
// Tab colors
pub const SELECTED_TAB_BACKGROUND: Color32 = ZINC_700;
pub const UNSELECTED_TAB_BACKGROUND: Color32 = ZINC_800;

// Address bar colors
pub const ADDRESS_BAR_BACKGROUND: Color32 = ZINC_800;
pub const ADDRESS_SEGMENT_HOVER: Color32 = ZINC_600;
pub const ADDRESS_SEPARATOR_COLOR: Color32 = ZINC_500;

// Animation bar colors
pub const ANIMATION_BAR_BACKGROUND: Color32 = ZINC_900;

// Network view colors
pub const NETWORK_BACKGROUND: Color32 = ZINC_900;
/// Grid lines - subtle contrast against zinc-900 background
pub const NETWORK_GRID: Color32 = ZINC_800;
...
// Base: ZINC_600 (82, 82, 91) - all variants stay dark and professional
pub const NODE_BODY_GEOMETRY: Color32 = ZINC_600;
...
pub const NODE_BODY_DEFAULT: Color32 = ZINC_600;
...
pub const CATEGORY_DEFAULT: Color32 = ZINC_500;
...
pub fn viewer_grid() -> Color32 {
    Color32::from_rgba_unmultiplied(161, 161, 170, 40) // zinc-400 with alpha
}
pub const VIEWER_CROSSHAIR: Color32 = ZINC_400;
...
// Timeline
pub const TIMELINE_BG: Color32 = ZINC_800;
pub const TIMELINE_MARKER: Color32 = ZINC_600;
...
pub const PORT_COLOR_GEOMETRY: Color32 = ZINC_600; // Same as node body
...
pub const DIALOG_BACKGROUND: Color32 = ZINC_800;
pub const DIALOG_BORDER: Color32 = ZINC_600;
pub const SELECTED_ITEM: Color32 = SELECTION_BG;
pub const HOVERED_ITEM: Color32 = ZINC_700;

// Button colors
pub const BUTTON_NORMAL: Color32 = ZINC_600;
pub const BUTTON_HOVER: Color32 = ZINC_500;
pub const BUTTON_ACTIVE: Color32 = ZINC_400;
...
pub fn configure_style(ctx: &egui::Context) {
    ...
    style
        .text_styles
        .insert(egui::TextStyle::Body, FontId::proportional(FONT_SIZE_BASE));
    ...
    visuals.window_stroke = Stroke::new(1.0, ZINC_600); // Very subtle border
    ...
    visuals.faint_bg_color = ZINC_800;
    visuals.extreme_bg_color = ZINC_950;

    // Visuals - Widgets (sharp corners, minimal borders)
    visuals.widgets.noninteractive.bg_fill = ZINC_800;
    visuals.widgets.noninteractive.weak_bg_fill = ZINC_800;
    ...
    visuals.widgets.inactive.bg_fill = ZINC_700;
    visuals.widgets.inactive.weak_bg_fill = ZINC_700;
    visuals.widgets.inactive.fg_stroke = Stroke::new(1.0, ZINC_200);
    visuals.widgets.inactive.corner_radius = CornerRadius::ZERO;
    visuals.widgets.inactive.bg_stroke = Stroke::NONE;

    visuals.widgets.hovered.bg_fill = ZINC_600;
    visuals.widgets.hovered.weak_bg_fill = ZINC_600;
    visuals.widgets.hovered.fg_stroke = Stroke::new(1.0, ZINC_100);
    ...
    visuals.widgets.active.bg_fill = ZINC_600;
    visuals.widgets.active.weak_bg_fill = ZINC_600;
    visuals.widgets.active.fg_stroke = Stroke::new(1.0, ZINC_100);
    visuals.widgets.active.corner_radius = CornerRadius::ZERO;
    visuals.widgets.active.expansion = 0.0;
    visuals.widgets.active.bg_stroke = Stroke::NONE;

    visuals.widgets.open.bg_fill = ZINC_600;
    visuals.widgets.open.weak_bg_fill = ZINC_600;
    visuals.widgets.open.fg_stroke = Stroke::new(1.0, ZINC_200);
