...
public class PlatformUtils {
    ...
    public static String getUserDataDirectory() {
        if (onMac()) {
            return getHomeDirectory() + SEP + "Library" + SEP + "Application Support" + SEP + APPLICATION_NAME;
        } else if (onWindows()) {
            return getHomeDirectory() + SEP + "Application Data" + SEP + APPLICATION_NAME;
        } else {
            return getHomeDirectory() + SEP + APPLICATION_NAME.toLowerCase();
        }
    }
