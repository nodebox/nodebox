...
/// use nodebox_core::ops::{align, HAlign, VAlign};
///
...
/// ```
/// use nodebox_core::{Point, Path};
/// use nodebox_core::ops::{copy, CopyOrder};
///
...
/// ```
/// use nodebox_core::{Path, Geometry};
/// use nodebox_core::ops::{group, ungroup};
///
/// let rect = Path::rect(0.0, 0.0, 100.0, 100.0);
/// let ellipse = Path::ellipse(0.0, 0.0, 50.0, 50.0);
/// let grouped = group(&[rect, ellipse]);
...
/// use nodebox_core::ops::to_points;
///
/// let path = Path::rect(0.0, 0.0, 100.0, 100.0);
...
/// ```
/// use nodebox_core::{Point, Path};
/// use nodebox_core::ops::translate;
///
/// let path = Path::rect(0.0, 0.0, 100.0, 100.0);
...
/// ```
/// use nodebox_core::Path;
/// use nodebox_core::ops::point_on_path;
///
...
/// ```
/// use nodebox_core::Path;
/// use nodebox_core::ops::path_length;
///
/// let path = Path::line(0.0, 0.0, 100.0, 0.0);
...
/// ```
/// use nodebox_core::Path;
/// use nodebox_core::ops::make_points;
///
/// let path = Path::line(0.0, 0.0, 100.0, 0.0);
...
/// ```
/// use nodebox_core::Path;
/// use nodebox_core::ops::resample_by_length;
///
/// let path = Path::line(0.0, 0.0, 100.0, 0.0);
