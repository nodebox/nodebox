...
public class ListUtilsTest {
    ...
    public void testListClass() {
        ...
        assertSame(Number.class, listClass(Lists.newArrayList(1, 2.0)));
        ...
        assertSame(nodebox.graphics.AbstractGeometry.class, listClass(Lists.newArrayList(new nodebox.graphics.Path(), new nodebox.graphics.Geometry())));
        assertSame(Object.class, listClass(Lists.newArrayList(new nodebox.graphics.Geometry(), null, new nodebox.graphics.Path())));
    }
